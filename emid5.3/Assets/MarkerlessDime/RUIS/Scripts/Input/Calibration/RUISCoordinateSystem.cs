...
public class RUISCoordinateSystem : MonoBehaviour
{
    ...
    {		
		...
		XmlNode calibrationMatrixElement = xmlDoc.CreateElement("ns2", "DIMEPairwiseCalibration", "http://teilab.tamu.edu/index.php?title=TAMU_Embodied_Interaction_Lab_%28TEILab%29");
		...
		XmlElement transformWrapperElement = xmlDoc.CreateElement("PS_Move-Kinect_2");
