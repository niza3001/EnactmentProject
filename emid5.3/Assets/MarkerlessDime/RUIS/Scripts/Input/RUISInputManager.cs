...
public class RUISInputManager : MonoBehaviour
{
    ...
    public List<Vector3> rbdXmlScale; 
    ...
    public bool enableOptitrack = false;
    public string OptitrackIP = "127.0.0.1";
    public int OptitrackPort = 7899;
    public string StoryTheme = "Jungle adventure"; 
...
//            GetComponentInChildren<RUISKinectDisabler>().KinectNotAvailable();
        ...
        else if(Application.loadedLevelName == "OptitrackScreen")
        {
            //Do this only during enactment screen 
