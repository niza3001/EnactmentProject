...
public class RUISInputManagerEditor : Editor {
    ...
    SerializedProperty enableOptitrack;
    SerializedProperty OptitrackIP;
    SerializedProperty OptitrackPort;
    SerializedProperty StoryTheme;
    ...
    void OnEnable()
    {
        ...
        enableOptitrack = serializedObject.FindProperty("enableOptitrack");
        OptitrackIP = serializedObject.FindProperty("OptitrackIP");
        OptitrackPort = serializedObject.FindProperty("OptitrackPort");
        StoryTheme = serializedObject.FindProperty("StoryTheme");
...
//        riftMagnetometerMode = serializedObject.FindProperty("riftMagnetometerMode");
    ...
    public override void OnInspectorGUI()
    {
        ...
        EditorGUILayout.PropertyField(StoryTheme, new GUIContent("Story Theme", "Story theme for today set by teacher"));
