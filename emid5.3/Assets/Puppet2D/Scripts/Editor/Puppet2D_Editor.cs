		...
		if(recordPngSequence && Application.isPlaying)
		{
			...
			{ 
                ...
                if (ExportPngAlpha)
                {
					...
					UnityEngine.ScreenCapture.CaptureScreenshot(pngSequPath + "_Alpha." + imageCount.ToString("D4") + ".png", resolution);
                }
                else
                {
                    //ScreenCapture.CaptureScreenshot(pngSequPath + "." + imageCount.ToString("D4") + ".png", resolution);
					UnityEngine.ScreenCapture.CaptureScreenshot(pngSequPath + "." + imageCount.ToString("D4") + ".png", resolution);
                }
