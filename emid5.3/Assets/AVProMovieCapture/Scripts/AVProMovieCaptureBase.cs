...
public class AVProMovieCaptureBase : MonoBehaviour 
{
    ...
    {
        /**************************************************************************DIME**********************************************************************/
        dimeFolder = PlayerPrefs.GetString("dimeFolder");
        selectionGrid = PlayerPrefs.GetInt("selectionGrid");
        tempArray = PlayerPrefsX.GetStringArray("beginTabArray");

        _outputFolderPath = dimeFolder + "Videos/";
        //string dataPath = Application.dataPath;
        //dataPath = dataPath.Substring(0, dataPath.Length - 1 - 6);
        //dataPath = Directory.GetParent(dataPath);
        //_outputFolderPath = dataPath + _outputFolderPath;
        PlayerPrefs.SetString("frameFolder", _outputFolderPath);
        //print(_outputFolderPath);


        if (_autoGenerateFilename || string.IsNullOrEmpty(_forceFilename))
        {
            string filename = selectionGrid + "." + _autoFilenameExtension;
        ...
        tempArray[selectionGrid] = _filePath;
        PlayerPrefsX.SetStringArray("beginTabArray", tempArray);
