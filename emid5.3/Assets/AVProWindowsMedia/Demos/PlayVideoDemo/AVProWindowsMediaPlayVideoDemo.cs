...
public class AVProWindowsMediaPlayVideoDemo : MonoBehaviour
{
	...
	public void OnGUI()
	{
		...
		if (_visible)
		{
			...
			GUILayout.BeginArea(new Rect(0, Screen.height*0.8f, Screen.width, Screen.height*0.2f), GUI.skin.box);
			ControlWindow(0);
			GUILayout.EndArea();
		}
	...
	void Update()
	{
		//Rect r = new Rect(0, Screen.height*0.8f, Screen.width, Screen.height*0.2f);
		/*
...
*/
	//GUILayout.BeginVertical ();
        if (moviePlayer != null)
        {
            ...
            float newPosition = GUILayout.HorizontalSlider(position, 0.0f, moviePlayer.DurationSeconds, GUILayout.Width(Screen.width * 0.8f));
